...
public class CreateViewAdapterSteps extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        switch (position) {
            ...
            case 2: return InitialStepsFragment.newInstance("Social Insurance Number", 0,"To obtain a Social Insurance Number (SIN) in Canada:\n" +
                    "\n" +
            ...
            case 3: return InitialStepsFragment.newInstance("Bank Account", 0,"When students arrive in Canada and want to open a Guaranteed Investment Certificate (GIC) account, they typically need the following:\n" +
                    "\n" +
            ...
            case 4: return InitialStepsFragment.newInstance("SIM Card", 0,"To get a SIM card in Canada:\n" +
                    "\n" +
